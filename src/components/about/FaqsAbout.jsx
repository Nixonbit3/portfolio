...
const CategoryIcons = {
  ...
  "Mi Experiencia": (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={iconStyle}>
      <path fill-rule="evenodd" d="M7.5 5.25a3 3 0 013-3h3a3 3 0 013 3V6h4.5A1.5 1.5 0 0122.5 7.5v12a1.5 1.5 0 01-1.5 1.5H3a1.5 1.5 0 01-1.5-1.5v-12A1.5 1.5 0 013 6h4.5v-.75zm3-1.5a1.5 1.5 0 00-1.5 1.5V6h3v-.75a1.5 1.5 0 00-1.5-1.5h-3z" clip-rule="evenodd" />
    </svg>
  ),
  "Mi formación": (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={iconStyle}>
